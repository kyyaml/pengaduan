        ...
        <div class="content shadow">
            ...
            <form action="{{ route('pekat.store') }}" method="POST" enctype="multipart/form-data">
                ...
                {{-- <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Tuliskan Judul">
                  </div> --}}
                <div class="form-group">
...
<div class="pengaduan mt-5">
    <div class="bg-purple">
        <div class="text-center">
            ...
            <h2 class="medium text-white">5</h2>
        </div>
    </div>
</div>
{{-- Footer --}}
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2021 SaveProject • All rights reserved</p>
    </div>
</div>
{{-- Modal --}}
